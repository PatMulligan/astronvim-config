        ...
        opts = {
          mappings = {
            n = {
              ...
              [prefix .. "w"] = { function() require("neotest").run.run() end, desc = "Run test" },
      ...
      require("neotest").setup {
        adapters = {
          require "neotest-vitest" {
            vitestCommand = "cross-env THOR_API_DB_PORT=6666 THOR_API_DB_HOST=localhost vitest --config ./test/integration/vitest.config.ts --coverage", -- Command being used to run tests. Defaults to vtest
            use_lsp = true,
          },
        },
      }
